...
export function AuthModal() {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="as-gpu relative max-h-[90dvh] w-full max-w-sm overflow-y-auto rounded-2xl border border-[#ebebeb] bg-white p-5 shadow-[0_12px_40px_rgba(0,0,0,0.18)]"
        style={{
          opacity: visible ? 1 : 0,
          transform: visible
      ...
      >
        <div className="mb-4 flex items-center justify-between">
          <h2
            id="auth-modal-title"
            className="font-[family-name:var(--font-display)] text-[18px] font-bold text-[#222222]"
          >
          ...
          <button
            type="button"
            onClick={close}
            className="as-press grid h-8 w-8 place-items-center rounded-full text-[#717171] hover:bg-[#f7f7f7]"
            aria-label={t("close")}
          >
            ×
          </button>
        ...
        <p className="mb-4 text-[13px] leading-relaxed text-[#717171]">
        ...
        <form onSubmit={onSubmit} className="space-y-3">
            ...
            <>
              <label className="block">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-[#dddddd] px-3 py-2.5 text-[14px] outline-none transition-[border-color,box-shadow] duration-150 focus:border-[#222222] focus:shadow-[0_0_0_3px_rgba(34,34,34,0.08)]"
                />
              </label>
              <label className="block">
                <span className="mb-1.5 block text-[12px] font-semibold text-[#222222]">
          ...
          <label className="block">
            ...
            <input
              ...
              className="w-full rounded-xl border border-[#dddddd] px-3 py-2.5 text-[14px] outline-none transition-[border-color,box-shadow] duration-150 focus:border-[#222222] focus:shadow-[0_0_0_3px_rgba(34,34,34,0.08)]"
            />
            <span className="mt-1 block text-[11px] text-[#717171]">
              {t("passwordHint")}
            </span>
          </label>

          {error && (
            <p className="as-rise-soft rounded-xl bg-[#fff8f6] px-3 py-2 text-[13px] text-[#c13515]">
              {error}
            </p>
          )}
